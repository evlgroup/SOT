function [x, tol, tr_radius] = evl_optimize_newton_trust_saddlefree(prob, x0, config)
%EVL_OPTIMIZE_NEWTON_TRUST_SADDLEFREE Saddle-free Newton method with trust region method
%
%   [x, tol] = evl_optimize_newton_trust_saddlefree(prob, x0, config)
...
%       x0 = 1;
%       evl_optimize_newton_trust_saddlefree(prob, x0, config)
